...
define("bricks-form",
  ["bricks-form/initializer","bricks-form/form-config","bricks-form/helpers/checkbox","bricks-form/helpers/radio","bricks-form/bu-editor","bricks-form/chosen-select","bricks-form/checkbox","bricks-form/radio","bricks-form/radio-button"],
...
define("bricks-form/chosen-select",
  ["exports"],
  function(__exports__) {
    "use strict";
...
define("bricks-form/controllers/checkbox_item",
  ["exports"],
  function(__exports__) {
    "use strict";
...
define("bricks-form/controllers/radio_item",
...
define("bricks-form/form-config",
  [],
  function() {
    "use strict";
    //样式配置,默认提供两种,
...
define("bricks-form/helpers/checkbox",
  [],
  function() {
    "use strict";
    //checkbox组
...
define("bricks-form/helpers/radio",
  [],
  function() {
    "use strict";
...
define("bricks-form/initializer",
  ["./form-setup"],
...
define("bricks-form/radio-button",
  ["exports"],
  function(__exports__) {
    "use strict";
...
define("bricks-metal",
  ...
  function(__dependency1__, __dependency2__, __dependency3__, __dependency4__) {
    ...
    Bricks.EventManager = EventManager;
    Bricks.Stateable = Stateable;
    Bricks.StateHandler = StateHandler;
  });
...
define("bricks-metal/stateable",
  ...
  function(__exports__) {
     ...
     *  事件触发,执行动作和行为转换
     *  组件通常都是粗粒度的,有自己内部机制,组合机制等等,Bricks采用FSM分离行为,作为默认的组合机制
